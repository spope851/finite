    ...
    <>
      {user
        ? <>  
            ...
            <AccountInfo>
              <p>
                <span className={'px-5'}>{`Username: ${user._id.username}`}</span>
                <span className={'px-5'}>{`Cash: $${Number(user._id.cash).toFixed(2)}`}</span>
                <span className={'px-5'}>{`Equity: $${Number(user.equity).toFixed(2)}`}</span>
              </p>
              <h2>Portfilio:</h2>
